...
static double domain_lb(ObjectiveFunction obj) {
    switch (obj) {
...
static double domain_ub(ObjectiveFunction obj) {
    switch (obj) {
...
static double eval_min(const double *x, uint32_t nd, ObjectiveFunction obj) {
    switch (obj) {
